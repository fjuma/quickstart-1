...
The following user must be added to the `ApplicationRealm` to run this quickstart. Make sure you use the username and password specified below as they are required to run this example.

[cols="20%,20%,20%,options="headers"]
|===
|Username |Password |Roles

|quickstartUser | quickstartPwd1! | guest |
|===

To add the above user, open a terminal and execute the following command:
